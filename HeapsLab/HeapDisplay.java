...
public class HeapDisplay extends TreeDisplay
{
    ...
    public HeapDisplay(String title)
    {
        super(title);
    }
     ...
     */
    public static TreeNode heapArrayToTree(Comparable[] heapArray, int heapSize)
    {
        if (heapArray == null || heapSize == 0) return null;  //does this edit reduce learning?  
        //if (heapSize == 0) return null;  // originally
